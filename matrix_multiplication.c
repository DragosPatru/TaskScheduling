...
/*
masuram timpul dintre -> dif dintre perioade , cuantele de timp
cu FIFO, un program simplu while(1) care are un sleep in while
---------|--------------- -> pt jitter masuram timpul dintre cat ruleaza programul si urmatoare planificare la executie

						__________|__________|__________|__________| -> schedtool
	
planificare la exec |___|prog_____|prog______| .... -> si timpul cat dureaza prog trebuie sa fie submultiplu de perioada
pt ca altfel e planificat in perioada urmatoare 
*/
